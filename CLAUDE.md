...
Radar Forge is an agent-powered daily digest generator for open-source project intelligence, currently focused on the AI open-source ecosystem. A GitHub Actions cron job runs at 00:00 UTC (08:00 CST) and produces five Chinese-language reports, published as GitHub Issues and committed Markdown files.
